...
/**
 * Chilean Privacy Law App - Separate from DORA
 * Route: /chile-privacy
 * This is the dedicated app for Ley 21.719 compliance
 */
...
export default function ChileanPrivacyHome() {
          ...
          <section className="py-24 bg-gradient-to-r from-blue-600 to-indigo-700">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                {isSpanish
                  ? 'Únase a las organizaciones que usan Nexus Cloud para automatizar su cumplimiento de Ley 21.719.'
                  : 'Join organizations using Nexus Cloud to automate their Ley 21.719 compliance journey.'}
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {isSpanish
                    ? 'Nexus Cloud es una herramienta de gestión de cumplimiento. No garantiza el cumplimiento. Los usuarios son responsables de asegurar el cumplimiento de todas las regulaciones aplicables.'
                    : 'Nexus Cloud is a compliance management tool. It does not guarantee compliance. Users are responsible for ensuring compliance with all applicable regulations.'}
                </p>
              </div>
            </div>
            <div className="border-t border-gray-800 pt-8 text-center text-sm">
              © {new Date().getFullYear()} Nexus Cloud. {isSpanish ? 'Todos los derechos reservados.' : 'All rights reserved.'}
            </div>
          </div>
        </footer>
      </main>
